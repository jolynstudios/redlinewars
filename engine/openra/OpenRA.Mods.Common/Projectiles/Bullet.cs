...
namespace OpenRA.Mods.Common.Projectiles
{
	...
	public class Bullet : IProjectile, ISync, IProjectileFlight
	{
		...
		// A bullet keeps no velocity: Tick interpolates along a fixed quadratic and remembers only
		// where it was. The tick displacement IS its velocity, and it is exact rather than derived.
		WVec IProjectileFlight.FlightVelocity => pos - lastPos;
		WPos IProjectileFlight.FlightTarget => target;
		int IProjectileFlight.FlightRemainingTicks => length > ticks ? length - ticks : 0;
