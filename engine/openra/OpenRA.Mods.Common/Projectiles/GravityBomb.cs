...
namespace OpenRA.Mods.Common.Projectiles
{
	...
	public class GravityBomb : IProjectile, ISync, IProjectileFlight
	{
		...
		WPos IProjectileFlight.FlightTarget => pos;

		// Free fall under acceleration; impact is decided by the ground, not by a counter.
