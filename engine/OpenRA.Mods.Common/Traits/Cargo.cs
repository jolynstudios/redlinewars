...
namespace OpenRA.Mods.Common.Traits
{
		...
		INotifyCreated, INotifyKilled, ITransformActorInitModifier
	{
		...
		/// <summary>Passengers that have reserved a seat and are walking in. Presentation opens the ramp from this.</summary>
		public int ReservedCount => reserves.Count;

		int unloadSessions;
		/// <summary>True while an UnloadCargo activity is running, including BeforeUnloadDelay.</summary>
		public bool IsUnloading => unloadSessions > 0;
		public void BeginUnload() => unloadSessions++;
