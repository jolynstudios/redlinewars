...
namespace OpenRA.Mods.Common.Projectiles
{
	...
	public class AreaBeam : IProjectile, ISync, IProjectileFlight
	{
		...
		WPos IProjectileFlight.FlightPosition => tailPos;
		WVec IProjectileFlight.FlightVelocity => WVec.Zero;
		WPos IProjectileFlight.FlightTarget => headPos;
		int IProjectileFlight.FlightRemainingTicks => IsBeamComplete ? 0 : Math.Max(1, length - Math.Min(headTicks, tailTicks));
