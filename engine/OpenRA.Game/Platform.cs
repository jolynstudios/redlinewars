...
namespace OpenRA
{
	...
	public static class Platform
	{
		...
		// Single-threaded runtimes (browser-wasm) cannot start threads or block on tasks;
		// code that would spawn worker threads must check this and run inline instead.
		public static bool SupportsThreads { get; } = !System.OperatingSystem.IsBrowser();
