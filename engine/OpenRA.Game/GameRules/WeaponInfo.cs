...
namespace OpenRA.GameRules
{
	public class ProjectileArgs
	{
		...
		public ushort PresentationWeaponClass;
		public ushort PresentationCaliber;
	}

	/// <summary>
	/// Value-only observer for actual weapon impacts; no simulation authority. Declared here
	/// too so presentation sources shared with the vendored engine (SteelseedEventObserver)
	/// compile in this tree. Only the native server and utility build this tree, and neither
	/// simulates, so its Impact does not notify observers.
	/// </summary>
